...
public:
    ...
    void printMastersList(int amountPeoples);
    void printDogs(int countDogs);
};
int Master::count = 0;
void menu();
    ...
    while (true) {
        ...
        case 1: {
            for (int i = 0; i < amountPeoples; i++) {
                cout << "\n\n" << i + 1 << " master:\n";
                master[i].printMastersList(amountPeoples);
            }
            break;
        }
        case 2: {
...
void Master::printMastersList(int amountPeoples) {
    cout << "Name: " << getNameMaster() << "  ";
    cout << "ID: " << getID() << "  ";
    cout << "Dogs: " << getCountDogs() << "\n";
    printDogs(getCountDogs());

}
void Master::printDogs(int countDogs)
{
    cout << "\n";
